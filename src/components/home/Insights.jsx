    ...
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-8 py-14">
        ...
        <div className="flex justify-between items-end mb-14">
          ...
          <Link
            to="/insights"
            className="inline-flex items-center gap-2 font-sans text-xs font-semibold uppercase text-forest-700 border-b border-transparent hover:border-gold hover:text-gold transition-all duration-200 no-underline whitespace-nowrap pb-px"
          >
            View all insights
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-px bg-line">
          ...
          <article className="lg:col-span-2 bg-cream flex flex-col overflow-hidden group">
            ...
            <div className="p-8 flex flex-col flex-1">
              ...
              <Link
                to="/insights"
                className="mt-6 inline-flex items-center gap-2 font-sans text-xs font-semibold uppercase text-forest-700 hover:text-gold transition-colors duration-200 no-underline"
              >
                Read article
          ...
          <div className="flex flex-col gap-px">
            ...
            <article className="bg-cream flex flex-col overflow-hidden group flex-1">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <Link
                  to="/insights"
                  className="mt-4 inline-flex items-center gap-2 font-sans text-xs font-semibold uppercase text-forest-700 hover:text-gold transition-colors duration-200 no-underline"
                >
                  Read article
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M5 12h14M13 5l7 7-7 7"/>
            ...
            <article className="relative overflow-hidden group flex-1 min-h-[200px]">
              ...
              <div className="relative p-6 flex flex-col h-full justify-end">
                ...
                <Link
                  to="/insights"
                  className="mt-4 inline-flex items-center gap-2 font-sans text-xs font-semibold uppercase text-gold-light hover:text-white transition-colors duration-200 no-underline"
                >
                  Read article
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M5 12h14M13 5l7 7-7 7"/>
