      ...
      <div className="max-w-7xl mx-auto px-8 py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-end mb-16">
          <div className={`transition-all duration-700 ${
            ...
            <h2 className="mt-4 font-serif font-light text-white leading-tight"
              style={{ fontSize: 'clamp(2.25rem, 3vw, 3.25rem)' }}
            >
              Four Platforms.<br />One Operating System.
            </h2>
          </div>
          <p className={`font-sans text-[0.88rem] font-light leading-relaxed text-white/65 transition-all duration-700 delay-100 ${
            visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-gold/15">
          {platforms.map((platform, i) => (
            ...
            >
              ...
              {/* Description */}
              <p className="font-sans text-[0.8rem] font-light leading-relaxed text-white/60">
                {platform.desc}
              </p>
