                ...
                <div className="flex flex-col gap-4 flex-1">
                  {category.items.map((item) => (
                    ...
                    >
                      ...
                      {/* Download Arrow */}
                      <button
                        className="text-navy-700 hover:text-navy-600 shrink-0 self-center transition-colors duration-200"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      ...
                      className="bg-white/10 border border-white/20 px-4 py-2.5 text-white placeholder-white/40 text-xs focus:outline-none focus:border-navy-600 transition-colors font-sans"
                    />
                    <input
                      type="email"
                      required
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 px-4 py-2.5 text-white placeholder-white/40 text-xs focus:outline-none focus:border-navy-600 transition-colors font-sans"
                  />
                  <select
                    value={formData.interest}
                    onChange={(e) => setFormData({ ...formData, interest: e.target.value })}
                    className="w-full bg-transparent border border-white/20 px-4 py-2.5 text-white/80 text-xs focus:outline-none focus:border-navy-600 transition-colors font-sans"
                    style={{ backgroundColor: '#13294b' }}
                  >
                    <option value="Data Licensing" style={{ backgroundColor: '#13294b' }}>Data Licensing</option>
                    <option value="Sovereign Advisory" style={{ backgroundColor: '#13294b' }}>Sovereign Advisory & SPV</option>
                    <option value="NPRA Pension Funds" style={{ backgroundColor: '#13294b' }}>NPRA Pension Management</option>
                    <option value="Private Equity" style={{ backgroundColor: '#13294b' }}>Private Equity & Trade</option>
                  </select>
                  <button
                    type="submit"
                    className="w-full py-3 bg-white text-navy-900 hover:bg-paper transition-colors duration-200 text-xs font-semibold tracking-wider uppercase font-sans"
                  >
                    Submit Request
                  </button>
                </form>
