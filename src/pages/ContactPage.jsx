          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-5 flex flex-col gap-10">
              ...
              <div>
                ...
                <h2 className="font-serif text-3xl font-medium text-navy-900 leading-snug mb-6">
                  Accra Headquarters
                </h2>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 font-sans text-base font-light leading-relaxed text-muted">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 font-sans text-base font-light text-muted">
                      +233 (0) 302 987 654
                    </p>
                  </div>
                </div>
            ...
            <div className="lg:col-span-7 bg-white border border-line p-10">
              ...
              {submitted ? (
                <div className="text-center py-12 font-sans">
                  <div className="w-20 h-20 bg-paper border border-navy-600 rounded-full flex items-center justify-center mx-auto mb-6 text-navy-700">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                      <path d="M20 6L9 17l-5-5" />
                    </svg>
                  </div>
                  <h3 className="font-serif text-3xl font-medium text-navy-900 mb-3">
                    Inquiry Registered
                  </h3>
                  <p className="font-sans text-base font-light leading-relaxed text-muted max-w-md mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <h3 className="font-serif text-3xl font-medium text-navy-900 mb-2">
                      Partnership Inquiry
                    </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">First Name</label>
                      <input
                        type="text"
                        required
                        value={formData.firstName}
                        onChange={(e) => setFormData({ ...formData, firstName: e.target.value })}
                        className="w-full bg-paper/40 border border-line px-4 py-3.5 text-base text-navy-900 placeholder-muted/50 focus:outline-none focus:border-navy-600 transition-colors font-sans"
                        placeholder="John"
                      />
                    </div>
                    <div>
                      <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">Last Name</label>
                      <input
                        type="text"
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">Institutional Email</label>
                      <input
                        type="email"
                        required
                    ...
                    <div>
                      <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">Telephone Number</label>
                      <input
                        type="tel"
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">Corporate Entity</label>
                      <input
                        type="text"
                        required
                        value={formData.firm}
                    ...
                    <div>
                      <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">Entity Type</label>
                      <select
                        value={formData.entityType}
                        onChange={(e) => setFormData({ ...formData, entityType: e.target.value })}
                        className="w-full bg-white border border-line px-4 py-3.5 text-base text-navy-900 focus:outline-none focus:border-navy-600 transition-colors font-sans"
                      >
                  ...
                  <div>
                    <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">Primary Advisory Channel</label>
                    <select
                  ...
                  <div>
                    <label className="font-sans text-sm font-semibold uppercase tracking-wider text-navy-900 block mb-2">Detailed Strategic Brief</label>
                    <textarea
                      required
                      rows="4"
      ...
      <section className="bg-white">
        <div className="max-w-8xl mx-auto px-10 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            {/* Hub 1 */}
            <div className="border border-line/60 p-10 flex flex-col">
              <span className="font-serif text-navy-600 text-4xl leading-none mb-4 font-light">Accra</span>
              <h3 className="font-sans font-semibold text-sm text-navy-900 uppercase tracking-wider mb-3">
